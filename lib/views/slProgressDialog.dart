...
import 'package:coffee_shop/models/appTextSetting.dart';
          ...
          Expanded(
            child: _progressDialogType == ProgressDialogType.Normal
                ? Text(_dialogMessage,
                    ...
                    style: TextStyle(
                        color: Color(AppTextSetting.APP_CONTENT_COLOR),
                        fontSize: 22.0,
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(color: Color(AppTextSetting.APP_CONTENT_COLOR), fontSize: 22.0),
                    ),
                  ),
                  SizedBox(width: 10.0),
                ],
